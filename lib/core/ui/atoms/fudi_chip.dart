...
class FudiChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final resolvedBg = backgroundColor ?? themeExt?.mutedBackground ?? theme.colorScheme.surfaceContainerLow;
    final resolvedIconColor = iconColor ?? theme.colorScheme.onSurface.withValues(alpha: 0.5);
    final resolvedLabelColor = labelColor ?? theme.colorScheme.onSurface;
