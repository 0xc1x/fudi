...
class _StepRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final image = Expanded(
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [
              FudiColors.secondary.withValues(alpha: 0.2),
              FudiColors.primary.withValues(alpha: 0.1),
            ],
          ),
    ...
    return Row(
      children: isReversed
          ? [image, const SizedBox(width: 80), content]
          : [content, const SizedBox(width: 80), image],
    );
  }
}
          ...
          child: Column(
            children: [
              ...
              _FAQCard(
                ...
                content:
                    'Una bolsa sorpresa es una selección de productos que el comercio prepara con los excedentes del día. El contenido es sorpresa, pero siempre vale más del triple de lo que pagas.',
              ),
              _FAQCard(
                title: '¿Puedo elegir qué viene en mi bolsa?',
                content:
                    'No, el contenido es sorpresa. Sin embargo, puedes ver la categoría del comercio y algunos ejemplos de productos que suelen incluir.',
              ),
              _FAQCard(
                title: '¿Qué pasa si no puedo recoger mi pedido?',
                content:
                    'Puedes cancelar tu reserva hasta 2 horas antes del horario de recogida sin ningún cargo. Después de ese tiempo, no podrás obtener un reembolso.',
              ),
            ],
          ),
        ),
