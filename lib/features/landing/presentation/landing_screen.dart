  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          bottom: BorderSide(
            color: FudiColors.borderSolid.withValues(alpha: isScrolled ? 1.0 : 0.0),
          ),
        ),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: TextButton(
        ...
        style: TextButton.styleFrom(
          foregroundColor: isDark ? FudiColors.foreground : Colors.white.withValues(alpha: 0.9),
  ...
  Widget build(BuildContext context) {
    return SliverToBoxAdapter(
      child: Padding(
        ...
        child: Column(
          children: [
            Text('¿Por qué elegir Fudi?', textAlign: TextAlign.center, style: FudiTypography.h2.copyWith(fontSize: 40, fontWeight: FontWeight.w800)),
            const SizedBox(height: FudiSpacing.lg),
            Text(
              'Una solución que beneficia a todos: comercios, usuarios y el planeta',
              textAlign: TextAlign.center,
              style: FudiTypography.bodyLarge.copyWith(color: FudiColors.mutedForeground, fontSize: 18),
            ),
            ...
            GridView.count(
              ...
              children: [
                _FeatureCard(
                  ...
                  description: 'Ayuda a restaurantes y comercios a reducir el desperdicio de alimentos mientras ahorras dinero.',
                ),
                _FeatureCard(
                  icon: '💰',
                  title: 'Ahorra hasta 70%',
                  description: 'Obtén productos de calidad a precios increíbles. Paga menos de la mitad del precio original.',
                ),
                _FeatureCard(
                  icon: '🌍',
                  title: 'Impacto positivo',
                  description: 'Cada compra que haces ayuda al planeta y apoya a los comercios locales de tu ciudad.',
                ),
                _FeatureCard(
                  icon: '⚡',
                  title: 'Fácil y rápido',
                  description: 'Reserva en segundos, recoge cuando te convenga. Todo desde tu móvil.',
                ),
              ],
            ),
          ],
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            title,
            textAlign: TextAlign.center,
            style: FudiTypography.labelMedium.copyWith(fontWeight: FontWeight.w700, fontSize: 18),
          ),
  ...
  Widget build(BuildContext context) {
    return SliverToBoxAdapter(
      child: Container(
        ...
        child: Column(
          children: [
            Text('Cómo funciona', style: FudiTypography.h2.copyWith(fontSize: 40, fontWeight: FontWeight.w800)),
            const SizedBox(height: FudiSpacing.lg),
            Text(
            ...
            GridView.count(
              ...
              children: [
                _HowItWorksStep(
                  ...
                  description: 'Busca restaurantes, panaderías y más en tu zona con productos disponibles.',
                ),
                _HowItWorksStep(
                  number: '2',
                  title: 'Reserva tu bolsa sorpresa',
                  description: 'Elige lo que te gusta y paga directamente desde la app.',
                ),
                _HowItWorksStep(
                  number: '3',
                  title: 'Recoge y disfruta',
                  description: 'Pasa por el comercio en el horario indicado y recoge tu pedido.',
                ),
              ],
            ),
          ],
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            title,
            textAlign: TextAlign.center,
            style: FudiTypography.h3.copyWith(fontWeight: FontWeight.w700, fontSize: 20),
          ),
  ...
  Widget build(BuildContext context) {
    return SliverToBoxAdapter(
      child: Padding(
        ...
        child: Column(
          children: [
            Text('Lo que dicen nuestros usuarios', style: FudiTypography.h2.copyWith(fontSize: 40, fontWeight: FontWeight.w800)),
            const SizedBox(height: FudiSpacing.lg),
            Text(
              ...
              child: ListView(
                ...
                children: const [
                  ...
                  _TestimonialCard(
                    ...
                    text: 'Fudi me ha permitido reducir el desperdicio y conectar con nuevos clientes. Una solución brillante.',
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              '"$text"',
              style: FudiTypography.bodyLarge.copyWith(fontStyle: FontStyle.italic, color: FudiColors.foreground, height: 1.6),
              maxLines: 3,
          ...
          Row(
            children: [
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(name, style: FudiTypography.labelMedium.copyWith(fontWeight: FontWeight.bold, fontSize: 16)),
                  Text(role, style: FudiTypography.bodySmall.copyWith(color: FudiColors.mutedForeground)),
                ],
              ),
            ],
          ),
      ...
      child: Container(
        ...
        child: Center(
          child: Container(
            ...
            child: Column(
              children: [
                Text('Preguntas frecuentes', style: FudiTypography.h2.copyWith(fontSize: 40, fontWeight: FontWeight.w800)),
                const SizedBox(height: FudiSpacing.lg),
                Text(
                ...
                const _FAQItem(
                  ...
                  answer: 'Fudi es una plataforma que conecta comercios con excedente de comida con usuarios que quieren ahorrar dinero mientras ayudan al planeta. Los comercios ofrecen "bolsas sorpresa" con productos del día a precios reducidos.',
                ),
                const _FAQItem(
                  question: '¿Cómo funciona el sistema de reservas?',
                  answer: 'Simplemente explora los comercios disponibles cerca de ti, selecciona la bolsa sorpresa que quieras, paga en la app y recoge tu pedido en el horario indicado. Todo el proceso toma menos de 2 minutos.',
                ),
                const _FAQItem(
                  question: '¿Qué viene en una bolsa sorpresa?',
                  answer: 'Cada bolsa sorpresa contiene una selección de productos del comercio que de otra forma se desperdiciarían. El contenido es una sorpresa, pero siempre vale más del triple de lo que pagas.',
                ),
            const _FAQItem(
              question: '¿Cuánto puedo ahorrar?',
              answer: 'Normalmente ahorrarás entre un 50% y 70% del precio original. Por ejemplo, productos que valen €15 los puedes conseguir por €4.99.',
            ),
            const _FAQItem(
              question: '¿En qué ciudades está disponible Fudi?',
              answer: 'Actualmente operamos en Barcelona, Madrid, Valencia, Sevilla y Bilbao. Estamos expandiéndonos constantemente a nuevas ciudades.',
            ),
            const _FAQItem(
              question: '¿Cómo me registro como comercio?',
              answer: 'Puedes registrar tu comercio directamente desde la app o contactándonos a través del formulario de contacto. Te guiaremos en todo el proceso de configuración.',
            ),
              ],
            ),
          ),
...
class _FAQItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ExpansionTile(
        title: Text(question, style: FudiTypography.labelMedium.copyWith(fontWeight: FontWeight.bold, fontSize: 17)),
        ...
        children: [
          Text(answer, style: FudiTypography.bodyLarge.copyWith(color: FudiColors.mutedForeground, height: 1.6)),
        ],
      ),
    );
  }
          ...
          child: Column(
            children: [
              const Text(
                ...
                textAlign: TextAlign.center,
                style: TextStyle(color: Colors.white, fontSize: 48, fontWeight: FontWeight.w800, height: 1.1),
              ),
              const SizedBox(height: 24),
              const Text(
      ...
      children: [
        ...
        ...links.entries.map((link) => Padding(
              ...
              child: GestureDetector(
                ...
                child: Text(
                  link.key,
                  style: TextStyle(color: Colors.white.withValues(alpha: 0.5), fontSize: 15, fontWeight: FontWeight.w400),
                ),
              ),
            )),
      ],
      ...
      child: Container(
        ...
        child: Center(
          child: Container(
            ...
            child: Column(
              children: [
                Text('Contáctanos', style: FudiTypography.h2.copyWith(fontSize: 40, fontWeight: FontWeight.w800)),
                const SizedBox(height: FudiSpacing.lg),
                Text(
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 24),
        const _ContactField(label: 'Mensaje', hint: 'Escribe tu mensaje aquí...', maxLines: 5),
        const SizedBox(height: 40),
        FilledButton(
          onPressed: () {},
          style: FilledButton.styleFrom(
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            hintText: hint,
            hintStyle: TextStyle(color: FudiColors.mutedForeground.withValues(alpha: 0.5)),
            filled: true,
...
class _ContactInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('Información de contacto', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24)),
        const SizedBox(height: 40),
        const _ContactInfoItem(icon: Icons.email_outlined, title: 'Email', value: 'hola@fudi.app'),
        const SizedBox(height: 32),
        const _ContactInfoItem(icon: Icons.phone_outlined, title: 'Teléfono', value: '+34 900 123 456'),
        const SizedBox(height: 32),
        const _ContactInfoItem(icon: Icons.location_on_outlined, title: 'Oficina', value: 'Carrer de la Pau, 10\n08002 Barcelona, España'),
      ],
    );
  }
}
...
class _ContactInfoItem extends StatelessWidget {
  const _ContactInfoItem({required this.icon, required this.title, required this.value});
  final IconData icon;
  final String title;
  final String value;
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(color: FudiColors.primary.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(12)),
        ...
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(title, style: TextStyle(color: FudiColors.mutedForeground, fontSize: 14)),
            const SizedBox(height: 4),
            Text(value, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, height: 1.4)),
          ],
        ),
      ],
    );
