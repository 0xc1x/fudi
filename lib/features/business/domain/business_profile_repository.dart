...
abstract class BusinessProfileRepository {
  ...
  Future<List<BusinessReview>> getBusinessReviews(String businessId, {int limit = 5});
  Future<List<BusinessProfile>> getBusinessesByOwnerId(String ownerId);
  Future<void> createBusiness(BusinessProfile profile, String ownerId, {XFile? logoFile, XFile? coverFile});
}
